            ...
            <section class='indent'>
                ...
                <table>
                    <tbody>
                        <tr>
                            <td>
                                <span class="inline-block">甲方（盖章）/法人代表签字：</span>
                            </td>
                            <td>
                                <span class="inline-block" style="margin-left: 20%">乙方（盖章）/签字：</span>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <p class="placeholderK" style="margin-left: 10%"></p>年<p class="placeholderK"></p>月<p class="placeholderK"></p>日
                            </td>
                            <td>
                                <p class="placeholderK"></p>年<p class="placeholderK"></p>月<p class="placeholderK"></p>日
                            </td>
                        </tr>
                    </tbody>
                </table>
