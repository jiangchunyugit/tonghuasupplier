...
<div class="box">
    ...
    <div>
        ...
        <#--C:\Users\53049\Desktop\blackLine.png-->
        <div style="height: 40px;">
            <div style="background-image:url('http://localhost:7181/static/img/blackLine.png');width:100;  height:25px;">
                宽度不够？
            </div>
        </div>
        <#--<div style="height:35px; ">-->
            <#--<div style="background-image:url('C:\Users\53049\Desktop\blackLine.png');width:100;  height:35px; position:absolute;    filter:alpha(opacity=50); opacity:0.6; -moz-opacity=0.6; z-index:1;">-->
                <#--宽度不够？-->
            <#--</div>-->
            <#--<div style=" width:100; height:30px;  float:left; z-index:10;">我是打字机</div>-->
        <#--</div>-->
        <h4 class="inline-block"></h4>
    </div>
    <div>
        <h4 class="inline-block">乙方：${02} （以下简称乙方） </h4>
    ...
    <div class="indent">
        ...
        <p class="placeholderT"></p>年
        <p class="placeholderT"></p>月
        <p class="placeholderT"></p>日至
        <p class="placeholderT"></p>年
        <p class="placeholderT"></p>月
        <p class="placeholderT"></p>日。乙方在经营过程中，应认同并遵守《居然设计家设计行业公约》（附件1）；乙方应本着诚信原则为甲方客户提供服务。
    </div>
    <div class="indent">
    ...
    <table>
        <tbody>
        <tr>
            <td> <h4 class="inline-block">户名：</h4> <p class="placeholder"></p> </td>
        </tr>
        <tr>
            <td> <h4 class="inline-block">开户行：</h4> <p class="placeholder"></p> </td>
        </tr>
        <tr>
            <td> <h4 class="inline-block">账号：</h4> <p class="placeholder"></p> </td>
        </tr>
        </tbody>
    </table>
    <h4>二、甲方义务</h4>
    ...
    <div class="indent">
        2. 甲方利用自身媒体优势对活跃度高的乙方优先进行包装推广，将乙方每月使用3D云设计软件生成的基于真实户型的优秀全屋整套设计方案在平台优先展示，帮助其获取更多客户点击及咨询量，提升知名度和美誉度。甲方推广宣传渠道包括且不限于室内外广告、平面广告、杂志、报刊等平面媒体，以及网页、微信、微博、网络等其他新媒体形式。
    </div>
    <div class="indent">
    ...
    <div class="indent">
        ...
        <div class="indent">
            ...
            <div class="indent">
                8. 甲方收取乙方与甲方客户签订的《设计合同》总额的 10% 作为平台服务管理费。
            </div>
            <h4>三、乙方义务</h4>
            <div class="indent">
            ...
            <div class="indent">
                7. 乙方应向客户积极推荐居然设计家合作品牌产品，凡签订《设计合同》的客户，乙方应保证客户在平台购买的主材及家具配饰单平米造价不低于
                <p class="placeholderT"></p>元/平米。
            </div>
            <div class="indent">
                8. 乙方须依照《设计合同》约定内容配合
                <p class="placeholderT">5</p>次以上现场施工服务。
            </div>
            <h4>四、结算办法</h4>
            ...
            <div class="indent">
                ...
                <ul class="list">
                   ...
                   <#--<tr>-->
                       <#--<td>${key.id}</td>-->
                       <#--<td>a</td>-->
                       <#--&lt;#&ndash;<td>${clientSourceData[key]}</td>&ndash;&gt;-->
                   <#--</tr>-->
                    <#--</#list>-->
            ...
            <div class="indent">
                3. 甲方向乙方支付客户采购产品实交款总额
                <p class="placeholderT">10%</p>的产品服务费，甲方分两次与乙方结算产品服务费款项。
                <ul class="list">
            ...
            <div class="indent">
                4. 甲方向乙方支付客户施工竣工结算额（不含管理费及税金）
                <p class="placeholderT">5%</p>的施工管理费，甲方分两次与乙方结算施工管理费款项。
            </div>
            <div class="indent">
                4.1在客户《施工合同》首期款付款到账后的次月内向乙方支付施工合同折税后的合同额的
                <p class="placeholderT">3%</p>
            </div>
            <div class="indent">
                5. 4.2在施工项目完成后且客户结清尾款后的次月内，甲方根据客户满意度评分标准向乙方支付至多施工竣工结算额（不含管理费及税金）的
                <p class="placeholderT">2%</p>作为施工管理费。如因结算产生竣工合同金额变更，甲方按最终竣工结算额为基数，调整向乙方的支付金额。竣工结算的施工管理服务费具体支付规则如下：
                <ul class="list">
            ...
            <div class="indent">
                3. 对于客户投诉，甲方先行接受处理，乙方应服从甲方的处理意见，对于拒不配合解决的，甲方有权扣押乙方款项或使用乙方已付“履约保证金”解决客诉。情节严重者，可视同乙方违约，甲方有权解除合同终止合作，对于造成甲方损失的并追究相应法律责任。
            </div>
            <div class="indent">
            ...
            <div class="indent">
                4. 本协议一式三份，甲方两份，乙方一份。本协议生效日期
                <p class="placeholderT"></p>年
                <p class="placeholderT"></p>月
                <p class="placeholderT"></p>日。
            </div>
            <table>
                <tbody>
                <tr>
                    <td> <span class="inline-block">甲方（盖章）/法人代表签字：</span> </td>
                    <td> <span class="inline-block" style="margin-left: 20%">乙方（盖章）/签字：</span> </td>
                </tr>
                <tr>
                    <td> <p class="placeholderK" style="margin-left: 10%"></p>年<p class="placeholderK"></p>月<p class="placeholderK"></p>日 </td>
                    <td> <p class="placeholderK"></p>年<p class="placeholderK"></p>月<p class="placeholderK"></p>日 </td>
                </tr>
                </tbody>
            </table>
            <br />
