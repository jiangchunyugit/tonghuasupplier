...
<section class="indent">
    5.5.合同保证金作为施工质量保证、施工服务保证、售后服务保证和其他违规处罚的担保。在合作期间内，因质量、维修、处罚等原因使用而减少合同保证金的，乙方应及时补足。
</section>
<section class="indent">
    5.6.甲方应在乙方最后一份施工合同保修期结束6个月后，将合同保证金无息退还给乙方。如乙方与甲方签约后未承接工程申请解除协议的，甲方应在乙方提出申请之日起30日内将合同保证金无息退还乙方。
</section>
<h4>六、返款方式及时间</h4>
<section class="indent">
