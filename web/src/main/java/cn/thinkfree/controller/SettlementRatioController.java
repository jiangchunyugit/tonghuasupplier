...
public class SettlementRatioController extends AbsBaseController {
     ...
     *
     */
    @ApiOperation(value = "前端--运营后台--结算比例--获取结算比例--吕启栋", notes = "根据结算比例编号获取结算比例")
    ...
    @MyRespBody
    @MySysLog(action = SysLogAction.SAVE,module = SysLogModule.PC_CONTRACT,desc = "拷贝结算比例")
    ...
    @MyRespBody
    @MySysLog(action = SysLogAction.CHANGE_STATE,module = SysLogModule.PC_CONTRACT,desc = "作废结算比例")
