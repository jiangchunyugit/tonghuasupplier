...
public enum DesignStateEnum {
     ...
     * 消费者	支付订单首款
     */
    STATE_150(150, "3D待交付", "业主支付订单收款", new Integer[]{160, 1501}),
    /**
     * 消费者	申请退款（收款或全款）
     */
    STATE_1501(1501, "退款中", "首款退款待设计公司审核", "首款退款待审核", "首款退款待审核", "业主对合同首款发起了申请退款", new Integer[]{1502, 150}),
    /**
     * 设计公司	同意退款
     */
    STATE_1502(1502, "退款中", "首款退款待平台审核", "首款退款待平台审核", "首款退款待平台审核", "设计公司同意退款", new Integer[]{1503, 150}),
    /**
     * 运营平台（财务）	同意退款
     */
    STATE_1503(1503, "退款中", "平台同意退款", new Integer[]{1504, 150}),
    /**
     * 运营平台（财务）	放款
     */
    STATE_1504(1504, "订单关闭", "财务放款", new Integer[]{}),
    /**
     * 设计师	上传3D效果图
     */
    STATE_160(160, "3D待确认", "设计师上传了3D效果图", new Integer[]{170, 1601}),
    /**
     * 消费者	申请退款（收款或全款）
     */
    STATE_1601(1601, "退款中", "首款退款待设计公司审核", "首款退款待审核", "首款退款待审核", "业主对合同首款发起了申请退款", new Integer[]{1602, 160}),
    /**
     * 设计公司	同意退款
     */
    STATE_1602(1602, "退款中", "首款退款待平台审核", "首款退款待平台审核", "首款退款待平台审核", "设计公司同意退款", new Integer[]{1603, 160}),
    /**
     * 运营平台（财务）	同意退款
     */
    STATE_1603(1603, "退款中", "平台同意退款", new Integer[]{1604, 160}),
    /**
     * 运营平台（财务）	放款
     */
    STATE_1604(1604, "订单关闭", "财务放款", new Integer[]{}),
    /**
     * 消费者	确认3D效果图
     */
     ...
     * 消费者	支付订单中期款
     */
    STATE_180(180, "施工图待交付", "业主支付了中期款", new Integer[]{190, 1801}),
    /**
     * 消费者	申请退款（收款或全款）
     */
    STATE_1801(1801, "退款中", "中期款退款待设计公司审核", "中期款退款待审核", "中期款退款待审核", "业主对合同中期款发起了申请退款", new Integer[]{1802, 180}),
    /**
     * 设计公司	同意退款
     */
    STATE_1802(1802, "退款中", "中期款退款待平台审核", "中期款退款待平台审核", "中期款退款待平台审核", "设计公司同意退款", new Integer[]{1803, 180}),
    /**
     * 运营平台（财务）	同意退款
     */
    STATE_1803(1803, "退款中", "平台同意退款", new Integer[]{1804, 180}),
    /**
     * 运营平台（财务）	放款
     */
    STATE_1804(1804, "订单关闭", "财务放款", new Integer[]{}),
    /**
     * 设计师	上传施工图
     */
    STATE_190(190, "施工图待确认", "设计师上传了施工图", new Integer[]{200, 1901}),
    /**
     * 消费者	申请退款（收款或全款）
     */
    STATE_1901(1901, "退款中", "中期款退款待设计公司审核", "中期款退款待审核", "中期款退款待审核", "业主对合同中期款发起了申请退款", new Integer[]{1902, 190}),
    /**
     * 设计公司	同意退款
     */
    STATE_1902(1902, "退款中", "中期款退款待平台审核", "中期款退款待平台审核", "中期款退款待平台审核", "设计公司同意退款", new Integer[]{1903, 190}),
    /**
     * 运营平台（财务）	同意退款
     */
    STATE_1903(1903, "退款中", "平台同意退款", new Integer[]{1904, 190}),
    /**
     * 运营平台（财务）	放款
     */
    STATE_1904(1904, "订单关闭", "财务放款", new Integer[]{}),
    /**
     * 消费者	确认交付物
     */
     ...
     * 消费者	支付订单款项（全款）
     */
    STATE_230(230, "3D待交付", "业主支付了订单（全款）", new Integer[]{240, 2301}),
    /**
     * 消费者	申请退款（收款或全款）
     */
    STATE_2301(2301, "退款中", "全款退款待设计公司审核", "全款退款待审核", "全款退款待审核", "业主对合同款发起了申请退款", new Integer[]{2302, 230}),
    /**
     * 设计公司	同意退款
     */
    STATE_2302(2302, "退款中", "全款退款待平台审核", "全款退款待平台审核", "全款退款待平台审核", "设计公司同意退款", new Integer[]{2303, 230}),
    /**
     * 运营平台（财务）	同意退款
     */
    STATE_2303(2303, "退款中", "平台同意退款", new Integer[]{2304, 230}),
    /**
     * 运营平台（财务）	放款
     */
    STATE_2304(2304, "订单关闭", "财务放款", new Integer[]{}),
    /**
     * 设计师	上传3D效果图
     */
    STATE_240(240, "3D待确认", "设计师上传了3D效果图", new Integer[]{250, 2401}),
    /**
     * 消费者	申请退款（收款或全款）
     */
    STATE_2401(2401, "退款中", "全款退款待设计公司审核", "全款退款待审核", "全款退款待审核", "业主对合同款发起了申请退款", new Integer[]{2402, 240}),
    /**
     * 设计公司	同意退款
     */
    STATE_2402(2402, "退款中", "全款退款待平台审核", "全款退款待平台审核", "全款退款待平台审核", "设计公司同意退款", new Integer[]{2403, 240}),
    /**
     * 运营平台（财务）	同意退款
     */
    STATE_2403(2403, "退款中", "平台同意退款", new Integer[]{2404, 240}),
    /**
     * 运营平台（财务）	放款
     */
    STATE_2404(2404, "订单关闭", "财务放款", new Integer[]{}),
    /**
     * 消费者	确认3D效果图
     */
     ...
     * 消费者	确认交付物	交易完成
     */
    STATE_270(270, "交易完成", "业主确认了交付物，并支付了尾款", new Integer[]{}),
    /**
     * 订单阶段逆行<br/>
     * 消费者	拒绝支付订单款项（超时未支付）
     */
