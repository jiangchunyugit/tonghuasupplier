...
//    STATE_500(, "待平台派单", "待签约", "", "", "待平台派单"),
//    STATE_510(, "待公司派单", "待签约", "待公司派单", "待公司派单", "待公司派单"),
//    STATE_520(, "待预交底", "待签约", "待预交底", "待预交底", "待预交底"),
//    STATE_530(, "待报价","待签约", "待报价", "待报价", "待报价"),
//    STATE_540(, "待报价审核","待签约", "待报价审核", "待报价审核", "待报价审核"),
//    STATE_550(, "待合同录入","待签约", "待合同录入", "待合同录入", "待合同录入"),
//    STATE_560(, "待签约","待签约", "待签约", "待签约", "待签约"),
//
//    STATE_600(, "首期款待支付", "首期款待支付", "待首期款支付", "待首期款支付", "待首期款支付"),
//    STATE_610(, "待开工", "待开工", "待开工", "待开工", "待开工"),
//    STATE_620(, "施工中", "施工中", "施工中", "施工中", "施工中"),
//    STATE_630(, "阶段款待支付", "待阶段款支付", "待阶段款支付", "待阶段款支付", "待阶段款支付"),
//    STATE_640(, "施工中", "施工中", "施工中", "施工中", "施工中"),
//    STATE_650(, "尾款待结算", "待尾款", "结算 待尾款结算", "待尾款结算 ", "待尾款结算"),
//
//    STATE_700(, "已完成", "已完成", "已完成", "已完成", "已完成"),
//    STATE_710(, "已取消", "已取消", "已取消", "已取消", "已取消"),
//    STATE_720(, "退款中", "退款中", "退款中", "退款中", "退款中"),
//    STATE_730(, "已关闭", "已关闭", "已关闭", "已关闭", "已关闭")
    ;
