  ...
  * Session并发控制策略
  */
 public class MyConcurrentSessionControlStrategy
   ...
   implements MessageSourceAware
 {
   ...
   protected void allowableSessionsExceeded(List<SessionInformation> sessions, int allowableSessions, SessionRegistry registry, HttpServletRequest request)
