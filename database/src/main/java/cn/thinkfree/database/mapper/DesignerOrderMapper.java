...
public interface DesignerOrderMapper {
    ...
    List<DesignOrderVo> selectByDesignerId(@Param("designerId") String designerId,@Param("status") Integer status, @Param("projectNos") List<String> projectNos,@Param("state") int state, @Param("pageNum") Integer pageNum,@Param("pageSize") Integer pageSize);

    long countByDesignerId(@Param("designerId") String designerId,@Param("status") Integer status, @Param("projectNos") List<String> projectNos, @Param("state") int state);
}