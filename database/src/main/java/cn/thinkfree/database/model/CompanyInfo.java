...
public class CompanyInfo extends BaseModel {
     ...
     * @mbg.generated
     */
    @NotBlank(message = "公司id不能为空值", groups = Severitys.Update.class)
     ...
     * @mbg.generated
     */
    @NotNull(message = "公司地址市不能为空值", groups = {Severitys.Insert.class, Severitys.Update.class})
    ...
    @NotBlank(message = "负责人手机号不能为空", groups = {Severitys.Insert.class, Severitys.Update.class})
    @Pattern(regexp = "^1\\d{10}$", message = "负责人手机号是11位以1开头数字", groups = {Severitys.Insert.class, Severitys.Update.class})
    ...
    @NotBlank(message = "地图选点不能为空值", groups = {Severitys.Insert.class, Severitys.Update.class})
    private String lbs;
     ...
     * @mbg.generated
     */
    @NotNull(message = "公司地址地区不能为空值", groups = {Severitys.Insert.class, Severitys.Update.class})
